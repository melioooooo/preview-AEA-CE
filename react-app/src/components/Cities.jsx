...
const Cities = () => {
    ...
    const cityData = [
        ...
        { id: 'metz', name: 'METZ', date: '100% ONLINE', tag: 'DÉPARTEMENT 57', inscriptionEnd: '1er MAI 2026', onlinePeriod: '11 MAI — 30 MAI', closed: true },
        { id: 'strasbourg', name: 'STRASBOURG', date: 'ONLINE ET ÉVÉNEMENT PHYSIQUE', tag: 'DÉPARTEMENT 67', inscriptionEnd: '08 MAI 2026', onlinePeriod: '09 MAI — 7 JUIN' }
    ];
