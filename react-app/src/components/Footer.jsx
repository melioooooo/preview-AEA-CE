        ...
        <div className="playin-footer">
            <div className="playin-container" style={{ textAlign: 'center' }}>
                ...
                <p style={{ marginBottom: '20px' }}>
                    ...
                    <a href={getAssetPath('assets/reglement-complet-qualifier-fc26-hoplan-2026-final.pdf')} target="_blank" style={{ color: 'var(--ce-red)', textDecoration: 'underline' }}>Règlement</a>{' '}
                    pour détail.
                </p>

                <div className="footer-links">
                    <a href={getAssetPath('assets/reglement-complet-qualifier-fc26-hoplan-2026-final.pdf')} target="_blank">Règlement
                        Officiel</a>
